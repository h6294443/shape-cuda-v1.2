...
../src/util/facnorm.c \
../src/util/fiteuler.c \
../src/util/free_uc3tensor.c \
../src/util/free_ucmatrix.c \
../src/util/free_ucvector.c \
../src/util/fvector.c \
...
./src/util/free_ucmatrix.o \
./src/util/free_ucvector.o \
./src/util/fvector.o \
...
./src/util/facnorm.d \
./src/util/fiteuler.d \
./src/util/free_uc3tensor.d \
./src/util/free_ucmatrix.d \
./src/util/free_ucvector.d \
./src/util/fvector.d \
...
src/util/%.o: ../src/util/%.c
	...
	/usr/local/cuda-9.0/bin/nvcc -G -g -lineinfo -pg -O0 --use_fast_math -Xcompiler -rdynamic -gencode arch=compute_61,code=sm_61 -m64 -odir "src/util" -M -o "$(@:%.o=%.d)" "$<"
