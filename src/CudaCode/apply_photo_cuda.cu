...
__global__ void ap_init_krnl32(
		struct dat_t *ddat,
		struct mod_t *dmod,
		struct pos_t **pos,
		int set, int nframes, unsigned char *type, float *dsum,
...
__global__ void ap_lambertlaw_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		float *intensity_factor,
		int4 *xylim,
...
__global__ void ap_harmlambert_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__global__ void ap_inholambert_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__global__ void ap_lommel_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__global__ void ap_harmlommel_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__global__ void ap_inholommel_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__global__ void ap_geometrical_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__global__ void ap_hapke_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__global__ void ap_harmhapke_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__global__ void ap_inhohapke_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__global__ void ap_kaas_init_krnl32(
		struct mod_t *dmod,
		float *phasefuncd,
		float *phase_d,
		float *scale_lommsee,
...
__global__ void ap_kaas_krnl32(
		struct mod_t *dmod,
				struct pos_t **pos,
				int nThreads,
				int body,
...
__global__ void ap_harmkaas_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__global__ void ap_inhokaas_krnl32(
		struct mod_t *dmod,
		struct pos_t **pos,
		int nThreads,
		int body,
...
__host__ void apply_photo_gpu32(
		struct mod_t *dmod,
		struct dat_t *ddat,
		struct pos_t **pos,
		int4 *xylim,
		...
		cudaStream_t *ap_stream)
{
	...
	case KAASALAINEN:
		...
		ap_kaas_init_krnl32<<<BLK,THD>>>(dmod, phasefuncf, phase_f,
				scale_lommsee, scale_lambert, nframes);
	...
	case INHOKAAS:
		/* Launch the HarmKaas kernel */
		for (f=1; f<=nframes; f++)
			ap_inhokaas_krnl32<<<BLKpx[f],THD,0,ap_stream[f-1]>>>(dmod,
					pos, nThreads[f], body, xylim, span[f], intensity_factor,
					phase_f, f);
